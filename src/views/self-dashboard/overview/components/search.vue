        ...
        <div class="flex jc-start flex-wrap">
          <el-form-item label="广告主类型">
            <el-select
              ...
              clearable
              placeholder="搜索"
              @change="changeSelectChannelType"
            >
              <el-option
          ...
          <el-form-item label="平台">
            <el-select
              v-model="searchForm.data.platform"
              class="search-con"
              clearable
              placeholder="搜索"
              filterable
          ...
          <el-form-item label="Channel">
            <el-select
              v-model="searchForm.data.channel"
              class="search-con"
              clearable
              placeholder="搜索"
              collapse-tags
              filterable
              @change="changeSelectChannel"
            >
              <el-option
          ...
          <el-form-item label="Pkg">
            <el-select
              v-model="searchForm.data.pkg"
              class="search-con"
              clearable
              placeholder="搜索"
              collapse-tags
              filterable
              @change="changeSelectPkg"
            >
              <el-option
