import{_ as i,b as s}from"./index-30657850.js";import{r as d,o as m,k as u,i as e,x as c,h as p,y as f,t as h,F as b}from"./vendor-bf64253d.js";const x={name:"WwExportExcel",props:{list:{type:Array,requrie:!0,default(){return[]}},tHeader:{type:Array,requrie:!0,default(){return[]}},filterVal:{type:Array,requrie:!0,default(){return[]}},filename:{type:String,requrie:!0,default:""},buttonName:{type:String,requrie:!1,default:"Export"},bookType:{type:String,requrie:!1,default:"xlsx"}},data(){return{searchForm:{options:{bookType:["xlsx","csv"],autoWidth:[!0,!1]},data:{filename:"",autoWidth:!0,bookType:"xlsx"},rules:{}},downloadLoading:!1}},created(){this.searchForm.data.bookType=this.bookType},methods:{handleDownload(){this.downloadLoading=!0,s(()=>import("./Export2Excel-1129cec0.js"),["static/js/Export2Excel-1129cec0.js","static/js/vendor-bf64253d.js"]).then(o=>{const r=this.list,t=this.formatJson(this.filterVal,r);o.export_json_to_excel({header:this.tHeader,data:t,filename:this.filename,autoWidth:this.searchForm.data.autoWidth,bookType:this.searchForm.data.bookType}),this.downloadLoading=!1})},formatJson(o,r){return r.map(t=>o.map(a=>t[a]))}}};function y(o,r,t,a,_,l){const n=d("el-button");return m(),u(b,null,[e(' <el-form :inline="true" :model="searchForm.data" class="flex jc-end"> '),e(' <div class="flex jc-start"> '),e(` <el-form-item label="\u5BFC\u51FA\u6587\u4EF6\u540D">
  ...
  </el-form> `),c(n,{icon:"Download",type:"primary",onClick:l.handleDownload},{default:p(()=>[f(h(t.buttonName),1)]),_:1},8,["onClick"])],2112)}var F=i(x,[["render",y]]);export{F as W};
